...
$sql="SELECT task.titolo,task.descrizione,task.datas,stato.Stato FROM task,utenti,aziende,settori,stato where task.KsUtenti=utenti.id AND task.KsStato=stato.id AND utenti.KsAziende=aziende.id And aziende.id=$id GROUP BY task.titolo";
